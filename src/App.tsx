...
export default function App() {
  ...
  const navItems = [
    { name: "풀스택 개발자", href: "https://fintech-internship-fullstack-sh.vercel.app	", external: true },
    { name: "서비스 기획자", href: "https://fintech-internship-serviceplanning-sh.vercel.app", external: true },
              ...
              {[
                {
                  ...
                  href: "https://fintech-internship-fullstack-sh.vercel.app	"
                },
                {
                  ...
                  href: "https://fintech-internship-serviceplanning-sh.vercel.app"
                }
              ].map((item, idx) => (
                <motion.a 
                  key={idx} 
